...
class PythonTestcase(Testcase):
    def _load_module(self):
        module_name = 'case_' + self.name.replace('/', '_').replace('\\', '_')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Run testsuite (Python + harness)')
    ...
    parser.add_argument(
        ...
        action='append',
        default=[],
        help='Root to scan for tests (can be used multiple times)',
    )
