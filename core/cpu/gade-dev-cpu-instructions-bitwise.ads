package Gade.Dev.CPU.Instructions.Bitwise is
   ...
   procedure RL (CPU : in out CPU_Context; Adjust_Flags : Boolean; Value : in out Byte);

   procedure RRC (CPU : in out CPU_Context; Adjust_Flags : Boolean; Value : in out Byte);

   procedure RR (CPU : in out CPU_Context; Adjust_Flags : Boolean; Value : in out Byte);
