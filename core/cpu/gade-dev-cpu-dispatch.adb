...
with Gade.Dev.CPU.Instructions.Rotates_Shifts;
with Gade.Dev.CPU.Instructions.Increments;
...
package body Gade.Dev.CPU.Dispatch is
   ...
   package Rotates_Shifts renames Gade.Dev.CPU.Instructions.Rotates_Shifts;
   package Increments renames Gade.Dev.CPU.Instructions.Increments;
   ...
   begin
      Table (16#80#) := ALU.Execute_ADD_A_B'Access;
      Table (16#86#) := ALU.Execute_ADD_A_Addr_HL'Access;
      Table (16#89#) := ALU.Execute_ADC_A_C'Access;
      Table (16#92#) := ALU.Execute_SUB_A_D'Access;
      Table (16#9B#) := ALU.Execute_SBC_A_E'Access;
      Table (16#A4#) := ALU.Execute_AND_A_H'Access;
      Table (16#AD#) := ALU.Execute_XOR_A_L'Access;
      Table (16#B7#) := ALU.Execute_OR_A_A'Access;
      Table (16#BE#) := ALU.Execute_CP_A_Addr_HL'Access;
      ...
      Table (16#3E#) := Loads.Execute_LD_A_Imm8'Access;
      Table (16#36#) := Loads.Execute_LD_Addr_HL_Imm8'Access;
      Table (16#03#) := Increments.Execute_INC_BC'Access;
      Table (16#04#) := Increments.Execute_INC_B'Access;
      Table (16#05#) := Increments.Execute_DEC_B'Access;
      Table (16#0B#) := Increments.Execute_DEC_BC'Access;
      Table (16#0C#) := Increments.Execute_INC_C'Access;
      Table (16#0D#) := Increments.Execute_DEC_C'Access;
      Table (16#13#) := Increments.Execute_INC_DE'Access;
      Table (16#14#) := Increments.Execute_INC_D'Access;
      Table (16#15#) := Increments.Execute_DEC_D'Access;
      Table (16#1B#) := Increments.Execute_DEC_DE'Access;
      Table (16#1C#) := Increments.Execute_INC_E'Access;
      Table (16#1D#) := Increments.Execute_DEC_E'Access;
      Table (16#35#) := Increments.Execute_DEC_Addr_HL'Access;
      Table (16#23#) := Increments.Execute_INC_HL'Access;
      Table (16#24#) := Increments.Execute_INC_H'Access;
      Table (16#25#) := Increments.Execute_DEC_H'Access;
      Table (16#2B#) := Increments.Execute_DEC_HL'Access;
      Table (16#2C#) := Increments.Execute_INC_L'Access;
      Table (16#2D#) := Increments.Execute_DEC_L'Access;
      Table (16#33#) := Increments.Execute_INC_SP'Access;
      Table (16#34#) := Increments.Execute_INC_Addr_HL'Access;
      Table (16#3B#) := Increments.Execute_DEC_SP'Access;
      Table (16#3C#) := Increments.Execute_INC_A'Access;
      Table (16#3D#) := Increments.Execute_DEC_A'Access;
      Table (16#07#) := Rotates_Shifts.Execute_RLCA'Access;
      Table (16#0F#) := Rotates_Shifts.Execute_RRCA'Access;
      Table (16#17#) := Rotates_Shifts.Execute_RLA'Access;
      Table (16#1F#) := Rotates_Shifts.Execute_RRA'Access;
      ...
      Table (16#09#) := ALU.Execute_ADD_HL_BC'Access;
      Table (16#10#) := Control.Execute_STOP'Access;
      Table (16#19#) := ALU.Execute_ADD_HL_DE'Access;
      Table (16#27#) := Control.Execute_DAA'Access;
      Table (16#29#) := ALU.Execute_ADD_HL_HL'Access;
      Table (16#2F#) := Control.Execute_CPL'Access;
      Table (16#37#) := Control.Execute_SCF'Access;
      Table (16#39#) := ALU.Execute_ADD_HL_SP'Access;
      Table (16#3F#) := Control.Execute_CCF'Access;
      Table (16#76#) := Control.Execute_HALT'Access;
      Table (16#81#) := ALU.Execute_ADD_A_C'Access;
      Table (16#82#) := ALU.Execute_ADD_A_D'Access;
      Table (16#83#) := ALU.Execute_ADD_A_E'Access;
      Table (16#84#) := ALU.Execute_ADD_A_H'Access;
      Table (16#85#) := ALU.Execute_ADD_A_L'Access;
      Table (16#87#) := ALU.Execute_ADD_A_A'Access;
      Table (16#88#) := ALU.Execute_ADC_A_B'Access;
      Table (16#8A#) := ALU.Execute_ADC_A_D'Access;
      Table (16#8B#) := ALU.Execute_ADC_A_E'Access;
      Table (16#8C#) := ALU.Execute_ADC_A_H'Access;
      Table (16#8D#) := ALU.Execute_ADC_A_L'Access;
      Table (16#8E#) := ALU.Execute_ADC_A_Addr_HL'Access;
      Table (16#8F#) := ALU.Execute_ADC_A_A'Access;
      Table (16#90#) := ALU.Execute_SUB_A_B'Access;
      Table (16#91#) := ALU.Execute_SUB_A_C'Access;
      Table (16#93#) := ALU.Execute_SUB_A_E'Access;
      Table (16#94#) := ALU.Execute_SUB_A_H'Access;
      Table (16#95#) := ALU.Execute_SUB_A_L'Access;
      Table (16#96#) := ALU.Execute_SUB_A_Addr_HL'Access;
      Table (16#97#) := ALU.Execute_SUB_A_A'Access;
      Table (16#98#) := ALU.Execute_SBC_A_B'Access;
      Table (16#99#) := ALU.Execute_SBC_A_C'Access;
      Table (16#9A#) := ALU.Execute_SBC_A_D'Access;
      Table (16#9C#) := ALU.Execute_SBC_A_H'Access;
      Table (16#9D#) := ALU.Execute_SBC_A_L'Access;
      Table (16#9E#) := ALU.Execute_SBC_A_Addr_HL'Access;
      Table (16#9F#) := ALU.Execute_SBC_A_A'Access;
      Table (16#A0#) := ALU.Execute_AND_A_B'Access;
      Table (16#A1#) := ALU.Execute_AND_A_C'Access;
      Table (16#A2#) := ALU.Execute_AND_A_D'Access;
      Table (16#A3#) := ALU.Execute_AND_A_E'Access;
      Table (16#A5#) := ALU.Execute_AND_A_L'Access;
      Table (16#A6#) := ALU.Execute_AND_A_Addr_HL'Access;
      Table (16#A7#) := ALU.Execute_AND_A_A'Access;
      Table (16#A8#) := ALU.Execute_XOR_A_B'Access;
      Table (16#A9#) := ALU.Execute_XOR_A_C'Access;
      Table (16#AA#) := ALU.Execute_XOR_A_D'Access;
      Table (16#AB#) := ALU.Execute_XOR_A_E'Access;
      Table (16#AC#) := ALU.Execute_XOR_A_H'Access;
      Table (16#AE#) := ALU.Execute_XOR_A_Addr_HL'Access;
      Table (16#AF#) := ALU.Execute_XOR_A_A'Access;
      Table (16#B0#) := ALU.Execute_OR_A_B'Access;
      Table (16#B1#) := ALU.Execute_OR_A_C'Access;
      Table (16#B2#) := ALU.Execute_OR_A_D'Access;
      Table (16#B3#) := ALU.Execute_OR_A_E'Access;
      Table (16#B4#) := ALU.Execute_OR_A_H'Access;
      Table (16#B5#) := ALU.Execute_OR_A_L'Access;
      Table (16#B6#) := ALU.Execute_OR_A_Addr_HL'Access;
      Table (16#B8#) := ALU.Execute_CP_A_B'Access;
      Table (16#B9#) := ALU.Execute_CP_A_C'Access;
      Table (16#BA#) := ALU.Execute_CP_A_D'Access;
      Table (16#BB#) := ALU.Execute_CP_A_E'Access;
      Table (16#BC#) := ALU.Execute_CP_A_H'Access;
      Table (16#BD#) := ALU.Execute_CP_A_L'Access;
      Table (16#BF#) := ALU.Execute_CP_A_A'Access;
      Table (16#C6#) := ALU.Execute_ADD_A_Imm8'Access;
      Table (16#CE#) := ALU.Execute_ADC_A_Imm8'Access;
      Table (16#D6#) := ALU.Execute_SUB_A_Imm8'Access;
      Table (16#DE#) := ALU.Execute_SBC_A_Imm8'Access;
      Table (16#E6#) := ALU.Execute_AND_A_Imm8'Access;
      Table (16#E8#) := ALU.Execute_ADD_SP_Imm8'Access;
      Table (16#EE#) := ALU.Execute_XOR_A_Imm8'Access;
      Table (16#F3#) := Control.Execute_DI'Access;
      Table (16#F6#) := ALU.Execute_OR_A_Imm8'Access;
      Table (16#FB#) := Control.Execute_EI'Access;
      Table (16#FE#) := ALU.Execute_CP_A_Imm8'Access;
      return Table;
   ...
   function Build_CB_Table return Handler_Table is
      Table : Handler_Table := [others => null];
   begin
      Table (16#00#) := Rotates_Shifts.Execute_RLC_B'Access;
      Table (16#01#) := Rotates_Shifts.Execute_RLC_C'Access;
      Table (16#02#) := Rotates_Shifts.Execute_RLC_D'Access;
      Table (16#03#) := Rotates_Shifts.Execute_RLC_E'Access;
      Table (16#04#) := Rotates_Shifts.Execute_RLC_H'Access;
      Table (16#05#) := Rotates_Shifts.Execute_RLC_L'Access;
      Table (16#06#) := Rotates_Shifts.Execute_RLC_Addr_HL'Access;
      Table (16#07#) := Rotates_Shifts.Execute_RLC_A'Access;
      Table (16#08#) := Rotates_Shifts.Execute_RRC_B'Access;
      Table (16#09#) := Rotates_Shifts.Execute_RRC_C'Access;
      Table (16#0A#) := Rotates_Shifts.Execute_RRC_D'Access;
      Table (16#0B#) := Rotates_Shifts.Execute_RRC_E'Access;
      Table (16#0C#) := Rotates_Shifts.Execute_RRC_H'Access;
      Table (16#0D#) := Rotates_Shifts.Execute_RRC_L'Access;
      Table (16#0E#) := Rotates_Shifts.Execute_RRC_Addr_HL'Access;
      Table (16#0F#) := Rotates_Shifts.Execute_RRC_A'Access;
      Table (16#10#) := Rotates_Shifts.Execute_RL_B'Access;
      Table (16#11#) := Rotates_Shifts.Execute_RL_C'Access;
      Table (16#12#) := Rotates_Shifts.Execute_RL_D'Access;
      Table (16#13#) := Rotates_Shifts.Execute_RL_E'Access;
      Table (16#14#) := Rotates_Shifts.Execute_RL_H'Access;
      Table (16#15#) := Rotates_Shifts.Execute_RL_L'Access;
      Table (16#16#) := Rotates_Shifts.Execute_RL_Addr_HL'Access;
      Table (16#17#) := Rotates_Shifts.Execute_RL_A'Access;
      Table (16#18#) := Rotates_Shifts.Execute_RR_B'Access;
      Table (16#19#) := Rotates_Shifts.Execute_RR_C'Access;
      Table (16#1A#) := Rotates_Shifts.Execute_RR_D'Access;
      Table (16#1B#) := Rotates_Shifts.Execute_RR_E'Access;
      Table (16#1C#) := Rotates_Shifts.Execute_RR_H'Access;
      Table (16#1D#) := Rotates_Shifts.Execute_RR_L'Access;
      Table (16#1E#) := Rotates_Shifts.Execute_RR_Addr_HL'Access;
      Table (16#1F#) := Rotates_Shifts.Execute_RR_A'Access;
      Table (16#20#) := Rotates_Shifts.Execute_SLA_B'Access;
      Table (16#21#) := Rotates_Shifts.Execute_SLA_C'Access;
      Table (16#22#) := Rotates_Shifts.Execute_SLA_D'Access;
      Table (16#23#) := Rotates_Shifts.Execute_SLA_E'Access;
      Table (16#24#) := Rotates_Shifts.Execute_SLA_H'Access;
      Table (16#25#) := Rotates_Shifts.Execute_SLA_L'Access;
      Table (16#26#) := Rotates_Shifts.Execute_SLA_Addr_HL'Access;
      Table (16#27#) := Rotates_Shifts.Execute_SLA_A'Access;
      Table (16#28#) := Rotates_Shifts.Execute_SRA_B'Access;
      Table (16#29#) := Rotates_Shifts.Execute_SRA_C'Access;
      Table (16#2A#) := Rotates_Shifts.Execute_SRA_D'Access;
      Table (16#2B#) := Rotates_Shifts.Execute_SRA_E'Access;
      Table (16#2C#) := Rotates_Shifts.Execute_SRA_H'Access;
      Table (16#2D#) := Rotates_Shifts.Execute_SRA_L'Access;
      Table (16#2E#) := Rotates_Shifts.Execute_SRA_Addr_HL'Access;
      Table (16#2F#) := Rotates_Shifts.Execute_SRA_A'Access;
      Table (16#30#) := Rotates_Shifts.Execute_SWAP_B'Access;
      Table (16#31#) := Rotates_Shifts.Execute_SWAP_C'Access;
      Table (16#32#) := Rotates_Shifts.Execute_SWAP_D'Access;
      Table (16#33#) := Rotates_Shifts.Execute_SWAP_E'Access;
      Table (16#34#) := Rotates_Shifts.Execute_SWAP_H'Access;
      Table (16#35#) := Rotates_Shifts.Execute_SWAP_L'Access;
      Table (16#36#) := Rotates_Shifts.Execute_SWAP_Addr_HL'Access;
      Table (16#37#) := Rotates_Shifts.Execute_SWAP_A'Access;
      Table (16#38#) := Rotates_Shifts.Execute_SRL_B'Access;
      Table (16#39#) := Rotates_Shifts.Execute_SRL_C'Access;
      Table (16#3A#) := Rotates_Shifts.Execute_SRL_D'Access;
      Table (16#3B#) := Rotates_Shifts.Execute_SRL_E'Access;
      Table (16#3C#) := Rotates_Shifts.Execute_SRL_H'Access;
      Table (16#3D#) := Rotates_Shifts.Execute_SRL_L'Access;
      Table (16#3E#) := Rotates_Shifts.Execute_SRL_Addr_HL'Access;
      Table (16#3F#) := Rotates_Shifts.Execute_SRL_A'Access;
