...
package Gade.Dev.Video.Tile_Map is
   ...
   type Positional_Tile_Map_Type is
     array (Vertical_Tile_Map_Range, Horizontal_Tile_Map_Range) of Tile_Index_Type;

   type Addessed_Tile_Map_Type is array (Word range 0 .. Map_Size - 1) of Tile_Index_Type;

   type Consolidated_Tile_Map_Access_Type is (Positional, Addressed);

   type Consolidated_Partial_Map_Type
     (Access_Type : Consolidated_Tile_Map_Access_Type := Positional)
   is record
      case Access_Type is
         when Positional =>
   ...
   type Consolidated_Tile_Map_Type is
     array (Tile_Data_Access_Type) of Consolidated_Partial_Map_Type;
