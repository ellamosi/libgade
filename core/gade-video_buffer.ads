package Gade.Video_Buffer is
   ...
   type Color_Component is range 0 .. 255 with Size => 8, Convention => C;

   pragma Warnings (Off, "* bits of * unused");
   type RGB32_Color is record
      Red   : Color_Component;
      Green : Color_Component;
      Blue  : Color_Component;
   end record
   with Convention => C, Size => Color_Component'Size * 4;
   ...
   type RGB32_Display_Buffer is
     array (Display_Vertical_Range, Display_Horizontal_Range) of RGB32_Color
   with Convention => C;
