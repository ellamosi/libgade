...
package body Gade.Dev.Cartridge is
   ...
   package Bank_Reader is new Ada.Sequential_IO(ROM_Bank_Address_Space);
   use Bank_Reader;
   ...
   begin
      ...
      then
         Switch_Banks(External_ROM, ROM_Banks_Range((Content and 16#03#) or (Byte(External_ROM.Current_Bank_1_Idx) and 16#0F#)));
      elsif
        Address in Mode_Specific_Select_IO_Address'Range and
