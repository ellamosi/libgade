package body Gade.Audio.Frame_Sequencer is
   ...
   procedure Step_Frame_Sequencer (Frame_Sequencer : in out Audio_Frame_Sequencer) is
   begin
   ...
   function Current_State (Frame_Sequencer : Audio_Frame_Sequencer) return State is
   begin
