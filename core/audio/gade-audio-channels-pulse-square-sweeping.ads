...
private
   ...
   for NRx0_Frequency_Sweep_IO use
     record
   ...
   function To_NRx0_Frequency_Sweep_IO is new
     Ada.Unchecked_Conversion (Source => Byte, Target => NRx0_Frequency_Sweep_IO);
   ...
   overriding
   procedure Disable (Channel : in out Sweeping_Square_Channel; Mode : Disable_Mode);
   ...
   overriding
   procedure Write_NRx0 (Channel : in out Sweeping_Square_Channel; Value : Byte);
