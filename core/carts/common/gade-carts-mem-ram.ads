package Gade.Carts.Mem.RAM is
   ...
   procedure Load (RAM : out RAM_Content; File : File_Type);

   procedure Save (RAM : RAM_Content; File : File_Type);
...
private
   ...
   Content_Size_For_RAM_Size : constant array (RAM_Size_Type) of RAM_Content_Size :=
     [None        => 0,
      -- Unused
      RAM_16kbit  => 2 * 1024,
      RAM_64kbit  => 8 * 1024,
