package body Gade.Carts.Mixins.Banked.RAM is
   ...
   overriding
   procedure Read_RAM
     (C : in out Banked_RAM_Cart; Address : External_RAM_IO_Address; V : out Byte) is
   begin
   ...
   overriding
   procedure Write_RAM
     (C : in out Banked_RAM_Cart; Address : External_RAM_IO_Address; V : Byte) is
   begin
   ...
   procedure Load_RAM_File
     (C : in out Banked_RAM_Cart; File : Ada.Streams.Stream_IO.File_Type) is
   begin
   ...
   procedure Select_RAM_Bank (C : in out Banked_RAM_Cart; I : Bank_Index) is
   begin
