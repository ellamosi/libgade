package body Gade.Carts.Mixins.MBC.Constructors is
   ...
   procedure Initialize
     (C           : in out MBC_Cart'Class;
      ...
      RAM_Content : RAM_Content_Access) is
   begin
   ...
   procedure Initialize
     (C                : in out MBC_Cart'Class;
      ...
      RAM_Bank_Factory : in out Bank_Factory'Class) is
   begin
      ROM_RAM_Constructors.Initialize (C, ROM_Content, RAM_Content, RAM_Bank_Factory);
   end Initialize;
