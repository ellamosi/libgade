...
package body Gade.Carts.Banks.RAM.MBC2.Constructors is
   ...
   function Create (Content : RAM_Content_NN_Access) return MBC2_RAM_Bank_NN_Access is
   ...
   procedure Initialize (B : out MBC2_RAM_Bank'Class; Content : RAM_Content_NN_Access) is
   begin
