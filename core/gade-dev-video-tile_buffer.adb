...
package body Gade.Dev.Video.Tile_Buffer is
   ...
   procedure Rasterize_Line (Raster : in out Raster_Tile_Line; Actual : Tile_Line_Type) is
   ...
   procedure Rasterize_Tile (Raster : in out Raster_Tile_Type; Actual : Tile_Type) is
   begin
      for Row in 0 .. 7 loop
   ...
   begin
      ...
      Rasterize_Tile (Buffer (Index), VRAM.Map.Tile_Data.All_Tile_Data (Integer (Index)));
   end Rasterize_Tile;
