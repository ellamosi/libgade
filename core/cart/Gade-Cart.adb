...
with Gade.Cart.RAM.Handlers.MBC2;     use Gade.Cart.RAM.Handlers.MBC2;
...
package body Gade.Cart is
   ...
   is
      ...
      package MBC2_RAM_Handler   renames Gade.Cart.RAM.Handlers.MBC2;
   ...
   begin
      Put_Line ("Header.RAM_Size: " & Header.RAM_Size'Img);
      return
        (case RAM_Handler_Kind is
            ...
            when MBC2 =>
               RAM_Handler_Access (MBC2_RAM_Handler.Create (Path))
        );
