...
private
   use Gade.External.ROM;
   use Gade.External.RAM;
   ...
   type Cartridge_Header is record
      ...
      Cartridge_Type     : Gade.Cartridge.Cartridge_Type;
   ...
   for Cartridge_Header use record
      ...
      Cartridge_Type     at 16#147# range 0 .. 7;
   ...
   for Cartridge_Header'Size use 16#150# * 8;
   type Cartridge_Header_Access is access Cartridge_Header;
