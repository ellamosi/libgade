...
from integration.snorpung.oh_sequence import OH_SAMPLES, play_oh_sequence


def test_snorpung_oh_samples(client, tests_root, artifacts_dir):
    root = tests_root
    rom = root / "assets" / "roms" / "snorpung" / "oh.gb"
    ...
    if missing_refs:
        pytest.skip(
            ...
            "`python3 integration/snorpung/generate_oh_refs.py`: {}".format(
    ...
    play_oh_sequence(client=client, rom_path=rom, sample_callback=verify_sample)
