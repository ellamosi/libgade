...
from integration.snorpung.pocket_sequence import POCKET_SAMPLES, play_pocket_sequence


def test_snorpung_pocket_samples(client, tests_root, artifacts_dir):
    root = tests_root
    rom = root / "assets" / "roms" / "snorpung" / "pocket.gb"
    ...
    if missing_refs:
        pytest.skip(
            ...
            "`python3 integration/snorpung/generate_pocket_refs.py`: {}".format(
    ...
    play_pocket_sequence(client=client, rom_path=rom, sample_callback=verify_sample)
